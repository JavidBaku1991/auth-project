...
allow read;
      ...
      request.resource.contentType.matches(image/.*) */}
        ...
        <input defaultValue={currentUser.username}  type='text' id='username' placeholder='Username' className='bg-slate-100 rounded-lg p-3'  onChange={handleChange}  autoComplete="current-password"/>
        <input defaultValue={currentUser.email}  type='email' id='email' placeholder='Email' className='bg-slate-100 rounded-lg p-3' onChange={handleChange}  autoComplete="current-password"/>
        <input  type='password' id='password' placeholder='Password' className='bg-slate-100 rounded-lg p-3'  onChange={handleChange} autoComplete="current-password"/>
